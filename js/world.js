class World {
    ...
    #generateBuildings() {
        ...
        for (const seg of this.graph.segments) {
            tmpEnvelopes.push(
                new Envelope(
                    // skeleton
                    seg,
                    // buildings will be made using the outer edges of an envelope of the road skeleton so width needs to be an addition of the below components.
        ...
        for (let seg of guides) {
            ...
            // support points of first building on the 'street'
            let q1 = seg.p1;
            let q2 = add(q1, scale(dir, buildingLength));
            supports.push(new Segment(q1, q2));

            // create further buildings along the length of street
